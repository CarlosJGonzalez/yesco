        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 p-0">
			...
			<div class="py-3 px-4">
				<?php include $_SERVER['DOCUMENT_ROOT']."/includes/alerts.php"; 
					$forms = $db->query("SELECT client,companyname,sum(num_desktop_search_appearances+num_mobile_search_appearances+billed_impressions) as appearances,sum(num_total_page_views+billed_clicks) as clicks,sum(num_messages_to_business) as messages,sum(num_directions_and_map_views) as directions,sum(ad_cost) as cost FROM advtrack.yelp_metrics a,experimac.locationlist b WHERE client = '".$_SESSION['client']."-".$_SESSION['storeid']."' AND start_date BETWEEN '".$from." 00:00:00' AND '".$to." 23:59:59' and a.client=concat('".$_SESSION['client']."-',b.storeid) group by client");
				?>
