      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 p-0">
			...
			<div class="py-3 px-4">
					...
					<div class="col-12 col-lg-6 mb-4">
						<div class="border p-3 bg-white">
							...
							<ol>
								...
								<li class="h5 font-light"><?php echo ucfirst($searched_keyword); ?></li>
								<?php } ?>
							</ol>
						</div>
					</div>
					<div class="col-12 col-lg-6 mb-4">
						<div class="border p-3 bg-white">
							...
							<ol>
								...
								<li class="h5 font-light"><?php echo ucfirst($clicked_keyword); ?></li>
								<?php } ?>
							</ol>
						</div>
					</div>
				...
				<div class="accordion">
					<div class="question">
						<a href="javascript:;" class="button py-2 px-4 h6 text-white bg-blue font-light read d-inline-block">View Table <i class="far tog fa-angle-right"></i></a>
						<div class="more" style="display:none;"> 
							<div class="table-responsive styled-table border clear">      
							  <div  style="position:relative;" >  
								<img src="../../googleads-php-lib/spinner_preloader.gif" id="loading-indicator" style="display: none;" />                     
								<div  id="report_keywords"> </div> 
							  </div>                                       
							</div>
				...
				<div class="table-responsive">
					<table class="table ">
						...
						<tbody>
							...
							?>
							<tr>
								<td class="align-middle"><?php echo ucfirst($keyword_name); ?></td>
								<td class="align-middle text-center"><?php echo $keyword_clicks; ?></td>
								<td class="align-middle text-center"><?php echo $keyword_impressions; ?></td>
