        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 p-0 mb-4">
        	...
        	<div class="px-4 py-3">
				...
				if (isset($_GET['edit-campaign-id'])){
					...
					$campaign = $db->getOne('mailchimp_campaigns', 'campaign_id');*/
					
					$cols = array("template_id", "display_name", "field_name", "type", "sort", "default_text", "campaign_id", "store_id");
					$db->where("campaign_id",$_GET['edit-campaign-id']);
					$campaign_fields = $db->get('mailchimp_campaign_email_template_fields', null, $cols);
											...
											<?php if(isset($template_field['template'])){ 
												...
												if($db->count>0){
													...
													<?php	break;
															case "contact_url": ?>
																<div class="form-group">
																	<input type="text" name="testing" class="form-control emailText" value="https://fullypromoted.com/">
																</div>
													<?php	break;
															default: ?>
																<div class="form-group">
