...
<head>
<meta charset="utf-8">
<title>Corporate Apparel | Fully Promoted</title>
		...
		<tr>
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#ffffff">
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 22px;"><h2 style="color:#005d9c; font-size: 22px; line-height: 30px; text-align: center;"><?php echo $vars['headline']; ?></h2><p style="line-height: 25px;"><?php echo $vars['para_1']; ?></p></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 22px;"><strong style="color:#2aaed8; font-size: 18px;"><?php echo $vars['headline_2']; ?></strong><p style="line-height: 25px;"><?php echo $vars['para_2']; ?></p></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="540">
							<table cellspacing="0" cellpadding="0" width="540" align="center">
								<tr>
									<td width="232"><img src="<?php echo $vars['image']; ?>" width="232" /></td>
									<td width="30">&nbsp;</td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#cccccc">
					...
					<tr>
						...
						<td width="540" align="center">
							<strong style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 22px; color: #005d9c;"><?php echo $vars['para_3']; ?></strong>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
