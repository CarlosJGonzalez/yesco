...
<head>
<meta charset="utf-8">
<title>Brand Awareness | Fully Promoted</title>
			...
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#ffffff">
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540">
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><?php echo $vars['para_1']; ?><br><br>
							<?php 
					...
					<tr>
						<td colspan="3" align="center"><img src="<?php echo $vars['image']; ?>" style="display: block;" /></td>
					</tr>
					<tr>
						<td colspan="3" height="30">&nbsp;</td>
					</tr>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#cccccc">
					...
					<tr>
						...
						<td width="540" align="center">
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 19px; line-height: 22px; color: #000000;"><em><?php echo str_replace("[[company_name]]",$active_location['companyname'],replace_characters($vars['para_3'], "<br>")); ?></em></span><br><br><a href="<?php echo $vars['contact_url']; ?>"><img src="https://localfullypromoted.com/promote/templates/img/contact-us.jpg" alt="Contact Us" /></a>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
