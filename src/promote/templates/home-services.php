...
<head>
<meta charset="utf-8">
<title>Home Services  | Fully Promoted</title>
		...
		<tr>
			<td>
				...
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#FFFFFF">
					<tr>
						<td align="center"><img src="<?php echo $vars['banner']; ?>" width="100%" alt="Hone Services" /></td>
					</tr>
				</table>
				<!--/banner-->
			</td>
			...
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#ffffff">
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540">
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><?php echo $vars['para1']; ?></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="540">
							...
							<strong style="color: #005d9c; font-size: 20px;"><?php echo $vars['headline']; ?></strong><br><?php echo $vars['para2']; ?></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="3">
							...
							<table cellpadding="0" cellspacing="0" width="600" align="center">
								...
								<tr>
									<td width="30">&nbsp;</td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 15px; line-height: 22px;"><strong><?php echo $vars['prod1']; ?></strong></span></td>
									<td width="15">&nbsp;</td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 15px; line-height: 22px;"><strong><?php echo $vars['prod2']; ?></strong></span></td>
									<td width="15">&nbsp;</td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 15px; line-height: 22px;"><strong><?php echo $vars['prod3']; ?></strong></span></td>
									<td width="30">&nbsp;</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width="15">&nbsp;</td>
									<td align="center"><img src="<?php echo $vars['image5']; ?>"/></td>
									<td width="15">&nbsp;</td>
									<td align="center"><img src="<?php echo $vars['image6']; ?>" /></td>
									<td width="30">&nbsp;</td>
								</tr>
								<tr>
									<td width="30">&nbsp;</td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 15px; line-height: 22px;"><strong><?php echo $vars['prod4']; ?></strong></span></td>
									<td width="15">&nbsp;</td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 15px; line-height: 22px;"><strong><?php echo $vars['prod5']; ?></strong></span></td>
									<td width="15">&nbsp;</td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 15px; line-height: 22px;"><strong><?php echo $vars['prod6']; ?></strong></span></td>
									<td width="30">&nbsp;</td>
								</tr>
							</table>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#cccccc">
					...
					<tr>
						...
						<td width="540" align="center">
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 22px; color: #000000;"><em><?php echo $vars['para3']; ?></em></span><br><br><a href="<?php echo $vars['contact_url']; ?>"><img src="https://localfullypromoted.com/promote/templates/img/contact-us.jpg" alt="Contact Us" /></a>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
