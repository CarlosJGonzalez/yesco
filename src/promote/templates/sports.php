		...
		<tr>
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#ffffff">
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540" align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 18px; line-height: 26px;">
							<p><?php echo $vars['para_1']; ?></p></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="3">
							...
							<table cellpadding="0" cellspacing="0" width="600" align="center">
								...
								<tr>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 26px;"><?php echo $vars['prod1']; ?></span></td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 26px;"><?php echo $vars['prod2']; ?></span></td>
								</tr>
								<tr>
								...
								<tr>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 26px;"><?php echo $vars['prod3']; ?></span></td>
									<td align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 26px;"><?php echo $vars['prod4']; ?></span></td>
								</tr>
							</table>
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540" align="center"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 18px; line-height: 26px;"><strong><?php echo $vars['para_2']; ?></strong></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 18px; line-height: 22px;"><p><strong style="color: #11549a;"><?php echo $vars['heading']; ?></strong></p></span>
							<p><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 26px;"><?php echo $vars['para_3']; ?></span></p>
							<?php echo $vars['list']; ?>
							<p style="font-family: Century Gothic, Helvetica, Arial, sans-serif; color:#11549a; font-size: 18px; line-height: 22px; font-weight: bold;"><?php echo $vars['heading_2']; ?></p>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#cccccc">
					...
					<tr>
						...
						<td width="540" align="center">
							<strong style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 22px; color: #000000;"><?php echo $vars['para_4']; ?></strong>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
