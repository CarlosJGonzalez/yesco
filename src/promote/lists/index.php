        	...
        	<div class="px-4 py-3">
				...
				if ($db->count > 0){
					foreach($lists as $list){
						$list_details = $mc->getList($list['list_id']);
					?>
						<div class="border rounded p-2 mb-3">
							<div class="row align-items-center">

								<div class="col-sm-4">
									<span class="h3 mb-1"><?php echo $list_details['name'] ?></span>
									<div class="d-block">
										<span class="text-blue text-uppercase font-weight-bold">Created</span>
										<span class="text-muted"><?php echo date("M d, Y",strtotime($list_details['date_created'])) ?></span>
									</div>
								</div>
								<div class="col-sm-8">
									<div class="d-flex justify-content-between align-items-center">
										<div class="mr-2">
											 <span class="h4 text-blue d-block mb-1 font-weight-bold"><?php echo $list_details['stats']['member_count']; ?></span>
