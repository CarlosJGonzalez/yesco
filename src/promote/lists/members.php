				...
				<table class="table">
					...
					<tbody>
						...
						<tr data-id="<?php echo $member["info"]['id']; ?>">
							...
							<td><span class="rounded-pill py-1 px-3 alert <?php echo $member["info"]['status']=="subscribed" ? "alert-success" : "alert-danger"; ?>"><?php echo ucfirst($member["info"]['status']); ?></span></td>
							<td><?php echo date("m/d/Y", strtotime($member["info"]['timestamp_opt'])); ?></td>
						</tr> 
						<?php } ?>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<a href="/promote/promote-list-example.csv" download><small id="download-csv-example"> Download Sample.</small></a>
									</div>
