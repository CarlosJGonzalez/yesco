        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 p-0">			
			...
			<div class="py-3 px-4">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link text-blue" data-toggle="tab" href="#tabs-snippets">Signatures</a>
					</li>
				</ul>
				...
				<div class="tab-content p-2">
						...
						<div class="row pb-4">
							<div class="col-12 col-lg-3">
								...
								<div class="box py-4 bg-light-custom mb-4 border text-center">
									<p class="h6">Total Reviews</p>
									<p class="h1 text-blue"><?php echo round($review_info['data']["qtt"])?></p>
								</div>
							</div>
					...
					<div id="tabs-snippets" class="tab-pane fade">
						<h2 class="font-light mb-3">Email Signature Snippets</h2>
						<div class="row justify-content-center">				
							...
							<div class="col-xl-4 px-3">
								<div class="p-3 border">
									<div class="mb-3">
										<table cellpadding="0" cellspacing="0" width="270" style="border: 1px solid #dedede; border-left: 5px solid #222; background: #ffffff; margin: 0 auto;">
											<tr>
												<td width="20"></td>
												<td height="60"><img src="<?php echo LOCAL_CLIENT_URL;?>img/how.png" /><br><span style="font-family: Helvetica, Arial, sans-serif; color: #000000; font-size: 12px; font-style: italic;">Rate your experience with <?php echo CLIENT_NAME; ?> <?php echo $active_location['companyname'] ?>!&nbsp;&nbsp;&nbsp;&nbsp;</span>
												</td>
												<td width="20"></td>
											</tr>
											<tr>
												<td width="20"></td>
												<td height="50">
													<?php echo $fb_html_view;?>&nbsp;&nbsp;<?php echo $goo_html_view;?>
												</td>
												<td width="20"></td>
											</tr>
										</table>
									...
									<div class="code">
										<small class="vCode d-block">View Script</small>
										<code>
							&#x3C;table cellpadding=&#x22;0&#x22; cellspacing=&#x22;0&#x22; style=&#x22;border: 1px solid #dedede; border-left: 5px solid #222; background: #ffffff;&#x22;&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;tr&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;td height=&#x22;60&#x22;&#x3E;&#x3C;img src=&#x22;<?php echo LOCAL_CLIENT_URL;?>img/how.png&#x22; /&#x3E;&#x3C;br&#x3E;&#x3C;span style=&#x22;font-family: Helvetica, Arial, sans-serif; color: #000000; font-size: 12px; font-style: italic;&#x22;&#x3E;Rate your experience with <?php echo CLIENT_NAME; ?> <?php echo $active_location['companyname'] ?>!&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x3C;/span&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;/td&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;/tr&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;tr&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;td height=&#x22;50&#x22;&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;<?php echo $fb_html;?>&#x26;nbsp;&#x26;nbsp;<?php echo $goo_html;?>
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;/td&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;/tr&#x3E;
&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;/table&#x3E;
										</code>
							...
							<div class="col-xl-3 px-3">
								<div class="p-3 border">
									<table cellpadding="0" cellspacing="0" style="border: 1px solid #dedede; background: #ffffff; margin: 0 auto;" width="250">
										<tr bgcolor="#C3122F">
											<td height="52" align="center"><img src="<?php echo LOCAL_CLIENT_URL;?>img/logo.png" height="40"/></td>
										</tr>
										<tr>
											<td height="62" align="center"><img src="<?php echo LOCAL_CLIENT_URL;?>img/how.png" /><br><span style="font-family: Helvetica, Arial, sans-serif; color: #000000; font-size: 12px; font-style: italic;">Rate your experience with <?php echo CLIENT_NAME; ?> <?php echo $active_location['companyname'] ?>!&nbsp;&nbsp;&nbsp;&nbsp;</span>
											</td>
										</tr>
										<tr>
...
&#x9;&#x9;&#x9;&#x9;&#x9;&#x3C;/table&#x3E;
							...
							<div class="col-xl-5 px-3">
								<div class="p-3 border">
									<table cellpadding="0" cellspacing="0" style="border: 1px solid #dedede; border-left: 5px solid #222; background: #ffffff; margin: 0 auto;" width="500">
										<tr>
											<td width="15"></td>
											<td height="110" valign="middle"><img src="<?php echo LOCAL_CLIENT_URL;?>img/logo-reverse.png" height="50"/></td>
											<td width="15"></td>
											<td height="110" valign="middle">
												<img src="<?php echo LOCAL_CLIENT_URL;?>img/how.png" /><br><span style="font-family: Helvetica, Arial, sans-serif; color: #000000; font-size: 12px; font-style: italic;">Rate your experience with <?php echo CLIENT_NAME; ?> <?php echo $active_location['companyname'] ?>!&nbsp;&nbsp;&nbsp;&nbsp;</span><br>
												<?php echo $fb_html_view;?>&nbsp;&nbsp;<?php echo $goo_html_view;?>
											</td>
											<td width="15"></td>
										</tr>
...
<script type="text/javascript">		    
	...
	var myLineChart = new Chart(ltx, {
		...
		var myPieChart = new Chart(ptx,{
			...
			data: {
				datasets: [{					
					data: [<?php echo implode(',', array_column($review_info['data']["by_star"],'qtt'));?>],
	...
	function fetch_data(start_date, end_date,filter_star = '',filter_portal = ''){
		...
		var userTable = $('#reviewTable').DataTable({
			...
			'serverSide': true,
			"pageLength": 10,
			"lengthMenu": [[10,100,300,500], [10,100,300,500]],
			'serverMethod': 'POST',
			'ajax': {
			  'url':'xt_review.php',
			...
			columnDefs: [
             ...
             'rowCallback': function(row, data, index){
             	...
             	$(row).find('td:eq(2)').addClass('p-3 text-yellow');
             	$(row).find('td:eq(3)').addClass('p-3');
             	$(row).find('td:eq(3)').css('max-width','600px');
