						...
						<div class="p-3 bg-white">
							<div id="step-1">
								...
								<div class="templates">
									<div class="row">
											...
											<div class="col-6 col-md-4 col-lg-3 col-xl-2 template text-center mb-5 d-flex flex-column cursor-pointer <?php if(isset($_SESSION['post']) && $_SESSION['post']['template']== $template['template_name']) echo " selected"; ?>">
							...
							<div id="step-3" class="">
								...
								foreach($lists as $list){
									$list_api = $cc->getList($list['list_id']);
									?>
									<label class="label cusor-pointer text-center d-flex" for="list-<?php echo $list_api['id']; ?>">
										<input  class="label__checkbox" type="radio" name="list" value="<?php echo $list_api['id']; ?>" type="checkbox" id="list-<?php echo $list_api['id']; ?>" <?php if(isset($_SESSION['post']) && $_SESSION['post']['list']== $list_api['id']) echo "checked"; ?> />
										<span class="label__text d-flex align-items-center">
										  <span class="label__check d-flex rounded-circle mr-2">
											...
											<div class="d-inline-block cursor-pointer text-left"><span class="font-weight-light font-lg letter-spacing-1 "><?php echo $list_api['name']; ?></span><span class="small d-block"><?php echo $list_api['contact_count']; ?> subscribers</span></div>
										</span>
									 </label>
								<?php } ?>
								...
								<div id="nonRadioOptionSelected">
									...
									<div id="importSubscriberFields">
										<div class="form-group">
											<!--<label class="font-12 text-uppercase bg-light py-1 px-2 mb-0 rounded-top letter-1 text-dark"></label>-->
											<div class="d-flex align-items-center">
								...
								<div class="row">
									<div class="col-md-6 offset-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control rounded-bottom rounded-right" name="subject" <?php if(isset($_SESSION['post']['subject'])) echo 'value="'.$_SESSION['post']['subject'].'"'; ?> required>
										</div>
										<div class="form-group">
											<label class="font-12 text-uppercase bg-light py-1 px-2 mb-0 rounded-top letter-1 text-dark">Campaign Title</label>
											<input type="text" class="form-control rounded-bottom rounded-right" name="campaign_title" <?php if(isset($_SESSION['post']['campaign_title'])) echo 'value="'.$_SESSION['post']['campaign_title'].'"'; ?> required>
										</div>
										<div class="form-group">
