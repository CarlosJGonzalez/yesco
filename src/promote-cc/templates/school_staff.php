...
<head>
<meta charset="utf-8">
<title>Back to School for Faculty & Staff | Fully Promoted</title>
			...
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#f2f2f2">
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540">
							<span style='font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 22px;'><?php echo $vars['para3']; ?></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
