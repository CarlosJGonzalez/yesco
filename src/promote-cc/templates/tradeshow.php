...
<head>
<meta charset="utf-8">
<title>Tradeshow | Fully Promoted</title>
<style>
	body {
		background: #dedede;
		height: 100%;
		...
		<tr>
			<td>
				...
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#FFFFFF">
					<tr>
						<td align="center"><img src="<?php echo $vars['banner']; ?>" width="100%" alt="Tradeshow Banner" /></td>
					</tr>
				</table>
				<!--/banner-->
			</td>
						...
						<table cellpadding="0" cellspacing="0">
							<tbody><tr>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/pens.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Pens</p>
								</td>
								<td width="30"></td>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/notebook.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Notepads</p>
								</td>
								<td width="30"></td>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/stress-reliever.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Stress Relievers</p>
								</td>
								<td width="30"></td>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/yoyo.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Yo-yos</p>
								</td>
							</tr>
						</tbody>
						</table>
				...
				<tr>
					<td colspan="2" style="padding: 0px 40px;">
						<table cellpadding="0" cellspacing="0">
							<tbody><tr>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/caps.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Caps</p>
								</td>
								<td width="30"></td>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/drawstring-bag.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Drawstring Bags</p>
								</td>
								<td width="30"></td>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/tumblrs.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Tumblers</p>
								</td>
								<td width="30"></td>
								<td width="100" style="text-align:center;">
									<img src="/promote/templates/img/tradeshow/mint-tin.jpg" alt="Tradeshow Image" style="width:100%;max-width:88px;" width="88">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #1ab7ea; padding-bottom: 15px;padding-top: 10px;">Mint Tins</p>
								</td>
							</tr>
							</tbody>
							</table>
		...
		<tr>
			<td>
				...
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#fff">
					<tr>
						<td width="30">&nbsp;</td>
						<td align="center" width="540" height="12"><p><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 20px; line-height: 22px;text-align: center;color:black;font-weight: 800;"><?php echo $vars['headline_3']; ?></span></p></td>
						<td width="30">&nbsp;</td>
					</tr>
				</table>
				<!--/white text bar-->
