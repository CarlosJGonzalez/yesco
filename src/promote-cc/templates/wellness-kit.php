...
<head>
<meta charset="utf-8">
<title>Wellness Kit | Fully Promoted</title>
<style>
	body {
		background: #dedede;
		height: 100%;
		...
		<tr>
			<td>
				...
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#FFFFFF">
					<tr>
						<td align="center"><img src="<?php echo $vars['banner']; ?>" width="100%" alt="Wellness Kit Banner" /></td>
					</tr>
				</table>
				<!--/banner-->
			</td>
		...
		<tr>
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#ffffff">
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540"><span style="font-family:Century Gothic, Helvetica, Arial, sans-serif;font-size:25px;font-weight:600;color:#23a7db;"><?php echo $vars['headline']; ?></span>
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif;line-height: 22px;"><p><?php echo replace_characters($vars['para'], "<br>"); ?></p>
							<p><?php echo replace_characters($vars['para_2'], "<br>"); ?></p></span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
						...
						<table cellpadding="0" cellspacing="0">
							<tbody>
								...
								<td width="275" style="text-align:left;">
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 22px; line-height:22px; color: #005d9c;font-weight: 600;"><?php echo $vars['headline_2']; ?></p>
									<p style="font-family: 'Century Gothic', Arial, sans-serif; font-size: 17px; line-height:22px; color: #000;"><?php echo replace_characters($vars['para_3'], "<br>"); ?></p>
									<?php echo str_replace("\\r\\n",'',$vars['para_textarea_rich']); ?>
								</td>
								<td width="30"></td>
								<td width="175" style="text-align:center;">
									<img src="/promote/templates/img/notebook.jpg" alt="PPE Image" style="width:100%;max-width:175px;" width="175">
								</td>
							</tr>
						</tbody>
						</table>
					...
					<td>
						...
						<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#ffffff">
							...
							<tr>
								<td width="30">&nbsp;</td>
								<td width="540">
									<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif;line-height: 22px;">
									<p><?php echo replace_characters($vars['para_4'], "<br>"); ?></p>
									<p><?php echo replace_characters($vars['para_5'], "<br>"); ?></p>
									</span>
								</td>
								<td width="30">&nbsp;</td>
							</tr>
		...
		<tr>
			<td>
				...
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#fff">
					<tr>
						<td width="30">&nbsp;</td>
						<td align="left" width="540"><p><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 20px; line-height: 22px;text-align: center;color:#23a7db;font-weight: 800;font-style: italic;"><?php echo $vars['headline_3']; ?></span></p></td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
                ...
                <table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#1d3349">
                    ...
                    <tr>
                        ...
                        <td width="540" style="text-align: center;">
							...
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 15px; line-height: 25px; color:white;"><a href="<?php echo $vars['contact_url']; ?>" style="color: #ffffff; text-decoration:none;">Shop Now </a> | <a href="<?php echo $vars['contact_url']; ?>" style="color: #ffffff; text-decoration:none;"> Contact Us</a></span>
						</td>
						<td width="30">&nbsp;</td>
                    </tr>	
					 <tr>
