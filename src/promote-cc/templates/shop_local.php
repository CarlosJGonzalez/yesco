...
<head>
<meta charset="utf-8">
<title>Shop Local | Fully Promoted</title>
		...
		<tr>
			<td>
				...
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#FFFFFF">
					<tr>
						<td align="center"><img src="<?php echo $vars['banner']; ?>" width="100%" alt="Shop Local Banner" /></td>
					</tr>
				</table>
				<!--/banner-->
			</td>
		...
		<tr>
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#ffffff">
					...
					<tr>
						<td width="30">&nbsp;</td>
						<td width="540"><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 22px;"><h2 style="color:#23a7db; text-align: center;"><?php echo $vars['title']; ?></h2><p style="line-height: 25px;"><?php echo replace_characters($vars['para'], "<br>"); ?></p></span></td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
		...
		<tr>
			<td>
				...
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#005d9c">
					<tr>
						<td align="center" height="12"><p><span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 18px; line-height: 22px;text-align: center;color:white;font-weight: 600;"><?php echo $vars['h2']; ?></span></p></td>
					</tr>
				</table>
				<!--/blue text bar-->
			</td>
					...
					<tr>
						...
						<td width="540">
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 33px;">
								<?php print_r ($vars['para_textarea_rich']); ?>
							</span>
						</td>
						<td width="30">&nbsp;</td>
					</tr>
			...
			<td>
				...
				<table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#f2f2f2">
					...
					<tr>
						...
						<td width="280">
							<span style="font-family: Century Gothic, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 33px;">
								<p><?php echo replace_characters($vars['para3'], "<br>"); ?></p>
							</span>
						</td>
						<td width="90" style="text-align: right;"><img src="<?php echo $vars['image']; ?>" alt="Supprot Small Business" style="display: block;"></td>
						<td width="30">&nbsp;</td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
                ...
                <table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto;" bgcolor="#1d3349">
					...
					<tr>
                        ...
                        <td width="540" style="text-align: center;">
							...
							<a href="#" style="color: #ffffff; text-decoration:none;"><img src="https://localfullypromoted.com/promote/templates/img/shop-local/fb-white.png" alt="Facebook"></a> <a href="#" style="color: #ffffff; text-decoration:none;"><img src="https://localfullypromoted.com/promote/templates/img/shop-local/twitter-white.png" alt="Twitter"></a> <a href="#" style="color: #ffffff; text-decoration:none;"><img src="https://localfullypromoted.com/promote/templates/img/shop-local/linkedin-white.png" alt="LinkedIn"></a> <a href="#" style="color: #ffffff; text-decoration:none;"><img src="https://localfullypromoted.com/promote/templates/img/shop-local/ig-white.png" alt="Instagram"></a></span>
						</td>
						<td width="30">&nbsp;</td>
                    </tr>
                    <tr>
