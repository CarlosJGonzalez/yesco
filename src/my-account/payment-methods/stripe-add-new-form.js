...
function stripeTokenHandler(token) {
  ...
  //Send ajax request
    $.ajax({
        url: "xt_new_stripe_object.php",
        method: "POST",
        data: {customer_id: $("input[name='current_customer_id']").val(),owner_email: token.email, id:token.id,object:token.type, card:JSON.stringify(token.card)},
        cache: false,
        dataType: "html",
