...
<div class="form-group">
	...
	<input type="text" value="<?php echo CLIENT_NAME; ?> {<?php echo $_SESSION['client']."-".$_SESSION['storeid']; ?>}[<?php echo $campid[0]['campid']; ?>] " name="numberName" id="numberNamePortalAdd" class="form-control"  />
</div>
