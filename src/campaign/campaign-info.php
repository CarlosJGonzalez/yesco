    								...
    								<tbody>
    									...
    									foreach($portals as $portal){
    										...
    										<tr>
    											...
    											<?php if(roleHasPermission('show_markup_ongoing_campaigns', $_SESSION['role_permissions'])){ ?>
    												<td><?php echo isset($portal['markup'])? $portal['markup'].'%' : '0%'; ?></td>
    											<?php } ?>
    											<td>
    												<?php 
    											...
    											<?php if(roleHasPermission('show_actions_ongoing_campaigns', $_SESSION['role_permissions'])){ ?>
    												<td >
													<a href="" title="Copy To Clipboard Tracking Url" class="text-light-d ml-1 delete" id="tracking_url" data-id="<?php echo $portal['id']; ?>">
                                                            <i class="fas fa-lg fa-link text-dark cursor-pointer"></i>
                                                        </a>
                                                        <input type="hidden" name="tracking_url" id="tracking_url_save">
                                                        &nbsp;&nbsp;
                                                        <a href="" title="Update" class="text-light-d ml-1 change_ctn" id="update_portal" data-id="<?php echo $portal['id']; ?>">
                                                            <i class="far fa-edit text-dark cursor-pointer"></i>
                                                        </a>
                                                        &nbsp;&nbsp;
    													<a href="" title="Change CTN" class="text-light-d ml-1 change_ctn" id="change_ctn" data-id="<?php echo $portal['id']; ?>">
    														<i class="fa fa-exchange text-dark cursor-pointer"></i>
    													</a>
    													&nbsp;&nbsp;
    													<a href="" title="Delete Portal" class="text-light-d ml-1 delete" id="delete_portal" data-id="<?php echo $portal['id']; ?>">
    										...
    										<div class="modal-body">
    											...
    											<div class="CTNOptions">
    												...
    												<div class="form-group">
    													...
    													<input type="text" value="<?php echo CLIENT_NAME; ?> {<?php echo $_SESSION['client']."-".$_SESSION['storeid']; ?>} " name="numberName" id="numberNamePortalAdd" class="form-control"  />
    												</div>
...
<!-- Change Campaign Info form-->
	...
	<script>
		...
		input.oninput = function() {
			numberNamePortalAdd.value = "<?php echo CLIENT_NAME; ?> {<?php echo $_SESSION['client']."-".$_SESSION['storeid']; ?>}[" + input.value + "]";
		};
