  ...
  <body class="bg-light cbp-spmenu-push">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
		...
		<?php $locationList = $db->where("storeid",$_SESSION['storeid'])->getOne("locationlist");?>
			...
			<div class="card-deck mb-4 dashboard">
				<div class="card rounded-0 border-0 box p-3">
					...
					<div class="card-body p-0">
						...
						<div class="field form-group">
							<label class="font-12 text-uppercase bg-light py-1 px-2 mb-0 rounded-top letter-1 text-dark">Website <span data-toggle="tooltip" data-placement="top" title="Enter the location part of your local website’s URL in lowercase letters separating each word with a dash and using no spaces (i.e., austin-tx or boynton-beach-fl)."><i class="far fa-question-circle"></i></span></label>
						...
						<div class="field form-group">
							...
							<input type="text" class="form-control rounded-bottom rounded-right phoneInput web_info" name="phone" value="<?php echo $locationList['phone']?>" <?php if(!$_SESSION["admin"]) echo "readonly"; ?>>
						</div>
						<!--<div class="form-group">
					...
					<div class="box p-3">
						<form action="" method="POST" id="frm_additional_attributes">
								...
								<div id="prod-container" class="border rounded-bottom rounded-right p-2">
									<div class="row">
										<div class="form-inline col-sm-3 mb-2">
											...
											<input type="text"  class ="form-control rounded" name="products[]" value="<?=(count($products)>0)?trim(array_shift($products)):'';?>" readonly />   
										</div>
										...
										<div class="form-inline col-sm-3 mb-2">
											<!--<i class="far fa-trash-alt removeProdRow cursor-pointer mr-2" aria-hidden="true"></i>-->
											<input type="text" class="form-control rounded" name="products[]" value="<?=trim($prod);?>" readonly />   
										</div>
										<?php } ?>
									</div>
								</div>
								...
								<div id="serv-container" class="border rounded-bottom rounded-right p-2">
									<div class="row">
										<div class="form-inline col-sm-3 mb-2">
											...
											<input type="text"  class ="form-control rounded" name="services[]" value="<?=(count($services)>0)?trim(array_shift($services)):'';?>" readonly />   
										</div>
										...
										<div class="form-inline col-sm-3 mb-2">
											<!--<i class="far fa-trash-alt removeServRow cursor-pointer mr-2" aria-hidden="true"></i>-->
											<input type="text" class="form-control rounded" name="services[]" value="<?=trim($serv);?>" readonly />   
										</div>
										<?php } ?>
									</div>
								</div>
								...
								<div id="brands-container" class="border rounded-bottom rounded-right p-2">
									<div class="row">
										<div class="form-inline col-sm-3">
											...
											<input type="text" class="form-control rounded w-90"  name="brands[]" value="<?=(count($brands)>0)?array_shift($brands):'';?>" readonly />   
										</div>
										<?php for($i=0;$i<count($brands);$i++){
											...
											<div class="form-inline col-sm-4">
												<!--<i class="far fa-trash-alt removeBrandRow cursor-pointer mr-2" aria-hidden="true"></i>-->
												<input type="text" class="form-control rounded w-90" name="brands[]" value="<?=$brand;?>" readonly />   
											</div>
										<?php } ?>
									</div>
								</div>
							...
							<div class="field form-group">
								...
								<small class="cusor-pointer languageAdd">+ Add Another</small>
							</div>
							<div class="field form-group">
    	...
    	$(document).ready(function(){
			...
			*/
			...
			$(".languageAdd").click(function(e){
				$("#language-container").append('<div class="form-inline col-sm-3"><i class="far fa-trash-alt removeLanguageRow mr-2" aria-hidden="true"></i> <input type="text" class="form-control w-90 rounded" name="languages[]">');
			});
			...
			$(".certsAdd").click(function(e){
				$("#certifications-container").append('<div class="form-inline col-sm-3 mb-2"><i class="far fa-trash-alt removeCertRow" aria-hidden="true"></i> <input type="text" class="form-control w-90 rounded" name="certifications[]">');
			});
			$(".specAdd").click(function(e){
				$("#specialties-container").append('<div class="form-inline col-sm-3 mb-2"><i class="far fa-trash-alt removeSpecRow" aria-hidden="true"></i> <input type="text" class="form-control w-90 rounded" name="specialties[]">');
			});
			$(".servAdd").click(function(e){
				$("#serv-container").append('<div class="form-inline col-sm-3 mb-2"><i class="far fa-trash-alt removeServRow" aria-hidden="true"></i> <input type="text" class="form-control w-90 rounded" name="services[]">');
			});
			$(".prodAdd").click(function(e){
				$("#prod-container").append('<div class="form-inline col-sm-3 mb-2"><i class="far fa-trash-alt removeProdRow" aria-hidden="true"></i> <input type="text" class="form-control w-90 rounded" name="products[]">');
			});
