...
function upload_image($params){
	...
	if(isset($params["allow_file_types"])){
		$params = (array)$params["allow_file_types"];
		$allow_file_types = array_map('strtolower', $params);
	...
	$footer = '<tr>
			<td>
				<table cellpadding="0" cellspacing="0" align="center" width="600" bgcolor="#333333">
					<tr>
						<td height="40" align="center"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 22px; color: #ffffff;">Copyright &copy; <?php echo date("Y");?>Yesco. All rights reserved.</span></td>			
					</tr>
				</table>
			</td>
		</tr>
