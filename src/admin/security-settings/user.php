										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control rounded-bottom rounded-right" name="storeid" 
													value="<?php echo $logins['storeid']?>" autocomplete="off" 
													<?php 
														if($_SESSION["user_role_name"] == 'admin_root' && $role_name != "store_user") {
															echo 'readonly';
														}elseif($_SESSION["user_role_name"] == 'admin_rep'){
															//echo 'readonly';
														}
													?> >
													<?php } ?>
