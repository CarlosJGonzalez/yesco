      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 p-0">
			...
			<div class="px-4 py-3">	
				...
				<?
				$rct = 1;
				$sql= "select avg(time_to_sec(timediff(end,start))) as timediff,sum(if(duration>29,1,0)) as b,count(*) as c,sum(if(duplicate=1,1,0)) as d from advtrack.calls where client = '".$_SESSION['client']."-".$_SESSION['storeid']."' and start between '".$from." 00:00:00' and '".$to." 23:59:59' and CASE WHEN campid=20 THEN duration>30 ELSE duration>14 END";
				...
				$sqlw = "select disposition,count(*) as c from advtrack.calls where client='".$_SESSION['client']."-".$_SESSION['storeid']."' and start between '".$from." 00:00:00' and '".$to." 23:59:59' and CASE WHEN campid=20 THEN duration>30 ELSE duration>14 END group by disposition";
					...
					<form name="portal_form" method="get" class="form-inline">
						<div class="d-flex d-xl-inline-block mb-2 mb-xl-0 mr-2 align-items-center">
							<span class="letter-spacing-1 text-uppercase small mr-2 mr-xl-0">CAMPAIGN:</span>
								...
								<?
								$sql="select name,campid from advtrack.campid where client='".$_SESSION['client']."-".$_SESSION['storeid']."' and type='C' order by name";
