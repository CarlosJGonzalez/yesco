...
<!--	<link rel="stylesheet" href="/css/styles-campaign-stats.css">-->
    ...
    <title>Campaign Data | Local <? echo $client; ?></title>
  </head>
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 p-0">
			...
			?>
										...
										<td><?php echo number_format($tot_leads,0);?> <?php if(!empty($lead_desc)){ ?><i class="far fa-question-circle cursor-pointer ml-1" data-container="body" data-toggle="popover" data-html="true" data-content="<?php echo $lead_desc;?>" data-trigger="focus" tabindex="0"></i> <?php } ?></td>
