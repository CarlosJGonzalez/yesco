...
<html lang="en">
  <head>
    ...
    <title>LinkedIn Organic | Local <?php echo CLIENT_NAME; ?></title>
  </head>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 p-0">
			...
			<div class="p-0 border-bottom mb-4">
				<div class="d-flex d-block align-items-center clearfix py-2 px-4">
					<h1 class="h2 font-light mb-0 text-center text-sm-left"><i class="fab fa-linkedin mr-2"></i>LinkedIn Organic</h1>
